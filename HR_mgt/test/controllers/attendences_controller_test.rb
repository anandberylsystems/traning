...
class AttendencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendence" do
    assert_difference('Attendence.count') do
      post attendences_url, params: { attendence: { attendence: @attendence.attendence, employee_id: @attendence.employee_id, entry_time: @attendence.entry_time, leave_time: @attendence.leave_time } }
    end
  ...
  test "should update attendence" do
    patch attendence_url(@attendence), params: { attendence: { attendence: @attendence.attendence, employee_id: @attendence.employee_id, entry_time: @attendence.entry_time, leave_time: @attendence.leave_time } }
