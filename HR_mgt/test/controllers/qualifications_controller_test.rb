...
class QualificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create qualification" do
    assert_difference('Qualification.count') do
      post qualifications_url, params: { qualification: { employee_id: @qualification.employee_id, graduation: @qualification.graduation, intermediate: @qualification.intermediate, passing_year: @qualification.passing_year, tenth: @qualification.tenth } }
    end
  ...
  test "should update qualification" do
    patch qualification_url(@qualification), params: { qualification: { employee_id: @qualification.employee_id, graduation: @qualification.graduation, intermediate: @qualification.intermediate, passing_year: @qualification.passing_year, tenth: @qualification.tenth } }
